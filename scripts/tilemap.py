...
NEIGHBOR_OFFSETS = [  # 9 locations around the player
    (-1, 0),
    (-1, -1),
    (0, -1),
    (1, -1),
...
class Tilemap:
    ...
    def tiles_around(self, pos):
        tiles = []
        tile_loc = (int(pos[0] // self.tile_size), int(pos[1] // self.tile_size))  # all the tiles around the player
        for offset in NEIGHBOR_OFFSETS:  # Checks the tiles around the player
